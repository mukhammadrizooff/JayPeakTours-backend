...
user2 = User.create(name: 'Muhammad Rizo', email: 'muhammad@gmail.com', username: 'muhammad');
user3 = User.create(name: 'Sumair Qaisar', email: 'sumair@gmail.com', username: 'sumair');
